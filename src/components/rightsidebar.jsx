...
export default function RightSidebar() {
  const links = [
    ...
    { name: "React State", path: "/state" },
    { name: "React Hooks", path: "/hooks" },
    { name: "React Router", path: "/router" },
  ];

  return (
    <aside className="fixed top-20 right-0 w-64 h-[calc(100vh-5rem)] border-l border-slate-200/50 bg-white/70 backdrop-blur-xl overflow-y-auto hidden lg:block z-40 shadow-[-10px_0_30px_rgba(0,0,0,0.02)]">
      <div className="p-6">
